...
session_start();
	if($_POST['submit']=='submit')
	{
		...
		$cid = $_SESSION['user_detail']['cid'];
		$query="insert into `order` (`date`,`payment_type`,`totalprise`,`cid`) values(CURRENT_TIMESTAMP,'COD','$total','$cid')";
		
		//echo $query;
		$result=mysqli_query($query);
		$q = "select max(`order_id`) as order_id from `order`";
		$result_order=mysqli_query($q) or die(mysqli_error());
		$r = mysqli_fetch_array($result_order);

		$order_id = $r['order_id'];
		$query = "update `cart` set `order_id`=".$order_id." where `order_id`=0 and `cid`=".$cid;
...
<head>
	<title>Salon and spa Bootstrap Responsive website Template | Default :: w3layouts</title>
						...
						<ul class="nav navbar-nav navbar-left cl-effect-15">
							...
							<li class="dropdown">
								...
								<ul class="dropdown-menu">
									<li>
										<a href="shop.php">Salon and spa</a>
									</li>
									<li>
			...
			<div class="container">
				...
				<div class="footer-cpy">
					...
					<div class="col-md-3 col-sm-6 footer-logo">
						<h3>
							<a href="index.php">box selling</a>
						</h3>
						<h4>about us</h4>

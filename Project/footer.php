...
<head>
    <title>Salon and spa Bootstrap Responsive website Template | Default :: weebly</title>
                        ...
                        <ul class="nav navbar-nav navbar-left cl-effect-15">
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <a href="shop_category.php">shop_category</a>
                                    </li>
                                    <li>
                                        <a href="shop_brand.php">shop_brand</a>
                                    </li>
                                    <li>
                            ...
                            <li>
                                    <a href="login.html" title="SignIn & SignUp"> <span class="fa fa-user nav-icon" aria-hidden="true"></span></a>
                                </li>
  ...
  <div class="addon-sec section">
    <div class="container">
        ...
        <div class="col-md-3 col-sm-3 col-xs-3 fimg1">
            <a href="footer1.html">
                <img src="images/f1.png" class="img-responsive" alt="optical-image">
            </a>
        </div>
        <div class="col-md-3 col-sm-3 col-xs-3 fimg1">
            <a href="footer2.html">
                <img src="images/f2.png" class="img-responsive" alt="optical-image">
            </a>
        </div>
        <div class="col-md-3 col-sm-3 col-xs-3 fimg1">
            <a href="footer3.html">
                <img src="images/f3.png" class="img-responsive" alt="optical-image">
            </a>
        </div>
        <div class="col-md-3 col-sm-3 col-xs-3 fimg1">
            <a href="footer4.html">
                <img src="images/f4.png" class="img-responsive" alt="optical-image">
            </a>
        </div>
        <div class="clearfix"> </div>
    </div>
